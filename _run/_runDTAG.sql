...
PRINT CONVERT(NVARCHAR,getdate(),120) + ' ------------------------------ Create Archiv DTAG Start'
:r $(pathname)\_pre\createArchivSchemaDTAG.sql
PRINT CONVERT(NVARCHAR,getdate(),120) + ' ------------------------------ Create Archiv DTAG Done'
...
PRINT CONVERT(NVARCHAR,getdate(),120) + ' - run company DTAG.sql'
:r $(pathname)_data/companyDTAG.sql
